...
fe = fg.add_entry()
ts = subprocess.check_output(["git", "log", "-1", "--pretty=%cI", "./src/poems.md"]).decode("utf-8").strip()
print(ts)
fe.guid("https://theohenson.com/poems.html#"+ts, permalink=False)
fe.link(href="https://theohenson.com/poems.html")
fe.author(name="Theo Henson", email="theodorehenson@protonmail.com")
fe.title("New poems published")
